    ...
    <div class="col-lg-4 col-md-6 col-sm-6">
      <div class="card card-stats">
          ...
          <div class="row">
            ...
            <div class="col-7 col-md-8">
              <div class="numbers">
                ...
                <p class="card-title">
                    &#8369;{{ (isset($sectorBudget)) ? number_format($sectorBudget->total(), 2) : '--' }}
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="card-footer ">
          <hr>
          <div class="stats">
            <i class="fa fa-calendar-o"></i> Budget of your Sector
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6">
      <div class="card card-stats">
          ...
          <div class="row">
            ...
            <div class="col-7 col-md-8">
              <div class="numbers">
                ...
                <p class="card-title">
                    &#8369;{{ (isset($sectorBudget)) ? number_format($sectorBudget->remaining(), 2) : '--' }}
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="card-footer ">
          <hr>
          <div class="stats">
            <i class="fa fa-clock-o"></i> Sector's Remaining Budget
          </div>
        </div>
      </div>
    </div>
...
<div class="row" style="margin: 5px 0px 0px 10px;">
  <div class="col-lg-7 bargraph card">
    ...
    <div class="row">
      <div class="col-lg-6" style="padding-right: 0px; margin-right: 0px;">
        <div class="mediumbox card  text-info" style="font-size:14px;">
          <span class="far fa-file-excel fa-5x ppmpicon"></span>
          <span class="ppmptitle"> Project Procurement Management Plan </span>
        </div>
      </div>
  ...
  <div class="col-lg-6" style="margin: 5px 0px 0px 0px; padding-left:25px !important;">
    <div class="card" style="border-radius: 5px !important;">
      <div class="card-body" style="padding-bottom: 0px !important; margin-bottom: 0px !important;">
        <div style="margin: 2px 6px 15px 6px; font-size: 17px;"> PPMP Categories </div>
