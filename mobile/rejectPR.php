...
$User_id = $_POST["uid"];
$type = 'App\Notifications\PRRejected';
...
$data = '{"message":"Your PR has been rejected!"}';

if(!empty($remarks)){
	$connect->query("UPDATE purchase_requests SET is_approved = '".$is_approved."', remarks = '".$remarks."', updated_at = '".$datenow."' 
	WHERE id='".$ID."'");
	}else{
		$connect->query("UPDATE purchase_requests SET is_approved = '".$is_approved."', updated_at = '".$datenow."' WHERE id='".$ID."'");
	}
