...
$queryResult=$connect->query("
	...
	where budget_proposals.user_id = '".$UID."' ORDER BY budget_proposals.id DESC
	");
...
$queryResult2=$connect->query("
	...
	LEFT OUTER JOIN departments
	on budget_proposals.department_id = departments.id 
	where budget_proposals.user_id = '".$UID."'
	AND budget_proposals.is_approved = '1' ORDER BY budget_proposals.id DESC
	");
...
$queryResult3=$connect->query("
	...
	on budget_proposals.department_id = departments.id 
	where budget_proposals.user_id = '".$UID."'
	AND budget_proposals.is_approved = '0' ORDER BY budget_proposals.id DESC
	");
...
$queryResult4=$connect->query("
	...
	on budget_proposals.department_id = departments.id 
	where budget_proposals.user_id = '".$UID."'
	AND budget_proposals.is_approved IS NULL ORDER BY budget_proposals.id DESC
	");
