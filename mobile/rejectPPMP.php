...
$User_id = $_POST["uid"];
$type = 'App\Notifications\PPMPRejected';
...
$data = '{"message":"Your PPMP has been rejected!"}';

if(!empty($remarks)){
	$connect->query("UPDATE projects SET is_approved = '".$is_approved."', remarks = '".$remarks."', updated_at = '".$datenow."' 
	WHERE id='".$ID."'");
	}else{
		$connect->query("UPDATE projects SET is_approved = '".$is_approved."', updated_at = '".$datenow."' WHERE id='".$ID."'");
	}
